...
<script language="javascript" type="text/javascript">
 ...
 /* var globallabel;
      ...
      onCreateLabel: function(label, node){
        ...
        var parentNode = node.getParents();
          if(parentNode.length>0){
            onClkNode(parentNode[0].name,node.name,parentNode);
          }
          else{
            alert("This is root node")
            document.getElementById("infovis2").innerHTML="";
          }
          st.onClick(node.id);
  ...
  function onClkNode(pname,cname,parentNode) {
    // The JSON here would need to be adapted to a swagmap (or vice-versa), of course...
    document.getElementById("infovis2").innerHTML="";
...
<div id="container">
  <div id="center-container">
    <div id="infovis"></div>
    <div id="infovis2" style=";height: 100px;width: 100%;position: absolute;top: 30px;"></div>
    <div id="log">LOG</div>
  </div>
</div>
</body>
