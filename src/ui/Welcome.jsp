...
font-family: bold;color: #0066FF">TUTORIAL</span>
  ...
  <i class="fa fa-angle-right" onclick="CLNav.getSubmenuitems()" id="rightangle"></i>
         <i class="fa fa-angle-down" onclick="CLNav.hidesubmenyitem()" id="downangle" style="display: none"></i>
    </span>
