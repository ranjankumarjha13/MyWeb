...
//                util.writeToLog(arrListeners[i].listener)
    ...
    this.registerEventListener=function(iEvtType,objFn,arrArgs,objSrc,iScope)//objSrc
    {
        ...
        if(!objSrc)
            objSrc=null;
        if(!iScope)
            iScope=Focus.crm.fbooks.Constants.SCOPE_APP;
    ...
    this.unregisterAllListeners=function(iScope)
    {
        ...
        {
            if(!iScope)
                iScope=Focus.crm.fbooks.Constants.SCOPE_SCREEN;
   ...
   this.getCenterPositions=function()
   {
    ...
    this.getFontFamily=function(byFontId)
    {
        ...
        switch(byFontId)
        {
            case Focus.crm.fbooks.Constants.IFont.ARIAL :
                sFamilyName="Arial";
                break;
            case Focus.crm.fbooks.Constants.IFont.CALIBRI :
                sFamilyName="Calibri";
                break;
            case Focus.crm.fbooks.Constants.IFont.CAMBRIA :
                sFamilyName="Cambria";
                break;
            case Focus.crm.fbooks.Constants.IFont.CAMBRIA_MATH :
                sFamilyName="Cambria Math";
                break;
            case Focus.crm.fbooks.Constants.IFont.CANDARA :
                sFamilyName="Candara";
                break;
            case Focus.crm.fbooks.Constants.IFont.COMIC_SANS_MS :
                sFamilyName="Comic Sans MS";
                break;
            case Focus.crm.fbooks.Constants.IFont.CONSOLAS :
                sFamilyName="Consolas";
                break;
            case Focus.crm.fbooks.Constants.IFont.CONSTANTIA :
                sFamilyName="Constantia";
                break;
            case Focus.crm.fbooks.Constants.IFont.CORBEL :
                sFamilyName="Corbel";
                break;
            case Focus.crm.fbooks.Constants.IFont.COURIER :
                sFamilyName="Courier";
                break;
            case Focus.crm.fbooks.Constants.IFont.COURIER_NEW :
                sFamilyName="Courier New";
                break;
            case Focus.crm.fbooks.Constants.IFont.FIXEDSYS :
                sFamilyName="Fixedsys";
                break;
            case Focus.crm.fbooks.Constants.IFont.FRANKLIN_GOTHIC :
                sFamilyName="Franklin Gothic";
                break;
            case Focus.crm.fbooks.Constants.IFont.GABRIOLA :
                sFamilyName="Gabriola";
                break;
            case Focus.crm.fbooks.Constants.IFont.GEORGIA :
                sFamilyName="Georgia";
                break;
            case Focus.crm.fbooks.Constants.IFont.IMPACT :
                sFamilyName="Impact";
                break;
            case Focus.crm.fbooks.Constants.IFont.LUCIDA_CONSOLE :
                sFamilyName="Lucida Console";
                break;
            case Focus.crm.fbooks.Constants.IFont.LUCIDA_SANS_UNICODE :
                sFamilyName="Lucida Sans Unicode";
                break;
            case Focus.crm.fbooks.Constants.IFont.MICROSOFT_SANS_SERIF :
                sFamilyName="Microsoft Sans Serif";
                break;
            case Focus.crm.fbooks.Constants.IFont.MS_SANS_SERIF :
                sFamilyName="MS Sans Serif";
                break;
            case Focus.crm.fbooks.Constants.IFont.MS_SERIF :
                sFamilyName="MS Serif";
                break;
            case Focus.crm.fbooks.Constants.IFont.PALATINO_LINOTYPE :
                sFamilyName="Palatino Linotype";
                break;
            case Focus.crm.fbooks.Constants.IFont.SEGOE_PRINT :
                sFamilyName="Segoe Print";
                break;
            case Focus.crm.fbooks.Constants.IFont.SEGOE_SCRIPT :
                sFamilyName="Segoe Script";
                break;
            case Focus.crm.fbooks.Constants.IFont.SEGOE_UI :
                sFamilyName="Segoe UI";
                break;
            case Focus.crm.fbooks.Constants.IFont.SEGOE_UI_SYMBOL :
                sFamilyName="Segoe UI Symbol";
                break;
            case Focus.crm.fbooks.Constants.IFont.SYSTEM :
                sFamilyName="System";
                break;
            case Focus.crm.fbooks.Constants.IFont.TAHOMA :
                sFamilyName="Tahoma";
                break;
            case Focus.crm.fbooks.Constants.IFont.TIMES_NEW_ROMAN :
                sFamilyName="Times New Roman";
                break;
            case Focus.crm.fbooks.Constants.IFont.TREBUCHET_MS :
                sFamilyName="Trebuchet MS";
                break;
            case Focus.crm.fbooks.Constants.IFont.VERDANA :
                sFamilyName="Verdana";
                break;
        }
        return sFamilyName;
